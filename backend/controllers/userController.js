...
const sendToken = require('../routes/utils/sendToken');
...
exports.storeUserChat = asyncErrorHandler(async (req, res, next) => {
    ...
    if (!text) {
        return next(new ErrorHandler('Chat text is required', 400));
    }
