...
const Chatbot = () => {
  const [messages, setMessages] = useState([{ role: "bot", text: "hii, how can I help you today?" },{role: "user", text: "this is niraj i need help with mobile selection"}]);
  ...
  const handleSendMessage = async (e) => {
    e.preventDefault();
     ...
     console.log("handle input callerd");
